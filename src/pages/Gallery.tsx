...
const Gallery = () => {
  ...
  const galleryItems = [
    ...
    },
    {
      ...
      description: "Award for groundbreaking research in cancer treatment methodologies",
      category: "Research",
      icon: <Award className="w-5 h-5" />
    },
    {
      ...
      description: "Recognition for introducing innovative cancer treatment technologies",
      category: "Innovation",
      icon: <Award className="w-5 h-5" />
    },
    {
      ...
      description: "Keynote speaker at the Global Healthcare Summit discussing future of oncology",
      category: "Conferences",
      icon: <Users className="w-5 h-5" />
    }
  ];

  const categories = ["All", "Awards", "Conferences", "Recognition", "Achievements", "Certificates", "Community", "Research", "Innovation"];
